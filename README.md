...
Вводим свой токен API, id сообщества (можно без минуса)  
...
<img width="884" height="871" alt="image" src="https://github.com/user-attachments/assets/6537497d-20eb-4083-a4cc-fc4c2319a43a" />



## **Downloader**  
Downloader позволяет скачивать изображения из любых, доступных Вам альбомов в ВК (Даже технических)  
...
Вставляем ссылку на любую доску/страницу, доступную Вам, в Пинтерест (Можно оставить стоковую ссылку, тогда будет скачиваться Ваша лента рекомендаций)  
